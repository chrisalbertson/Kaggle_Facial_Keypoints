...
def load_test_df():
    ...
    if verb: print('loading test data...')
...
def build_model():
    ...
    model.add(Convolution2D(32, (3, 3), input_shape=(imagesize_x, imagesize_y, 1)))
...
def build_tiny_model():
    ...
    model.add(Convolution2D(16, (3, 3), input_shape=(imagesize_x, imagesize_y, 1)))
    model.add(Activation('relu'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Dropout(0.2))
